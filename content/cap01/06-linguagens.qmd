...
- Restrições de integridade
  - Chave primária (`matricula_prof` identifica unicamente cada professor)
...
A linguagem de consulta SQL é **não-procedural**. Uma consulta recebe como entrada uma ou mais tabelas e sempre retorna uma única tabela. Exemplo para encontrar todos os professores da ESETI:
